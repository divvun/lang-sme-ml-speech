...
class Paths:
    ...
    def __init__(self, data_path, voc_id, tts_id):
        ...
        self.voc_latest_weights = self.voc_checkpoints/'wave_575K.pyt'
        ...
        self.tts_latest_weights = self.tts_checkpoints/'checkpoint_3000_st'
        ...
        self.forward_latest_weights = self.forward_checkpoints/'smj_new_weights.pyt'
        self.forward_latest_optim = self.forward_checkpoints/'smj_new_optim.pyt'
        ...
        #ASR with Forward
        self.asr_forward_checkpoints = self.base/'checkpoints'/f'{tts_id}.asr_forward'
        self.asr_forward_latest_weights = self.forward_checkpoints/'asr_latest_weights.bin'
        self.asr_forward_latest_optim = self.forward_checkpoints/'asr_latest_optim.pyt'
        self.asr_forward_output = self.base/'model_outputs'/f'{tts_id}.asr_forward'
        self.asr_forward_step = self.forward_checkpoints/'asr_step.npy'
        self.asr_forward_log = self.forward_checkpoints/'asr_tensorboard'
        self.asr_forward_attention = self.forward_checkpoints/'asr_attention'
        self.asr_forward_mel_plot = self.forward_checkpoints/'asr_mel_plots'
    ...
    def create_paths(self):
        ...
        os.makedirs(self.alg_dt, exist_ok=True)
