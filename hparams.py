...
wav_path = './data/speech-sme-tts/'
data_path = 'data/'

# model ids are separate - that way you can use a new tts with an old wavernn and vice versa
# NB: expect undefined behaviour if models were trained on different DSP settings
voc_model_id = 'sme_speech_raw'
tts_model_id = 'sme_speech_tts'
...
forward_schedule = [(1e-4, 10_000,  32),    # progressive training schedule
                    ...
                    (2e-5, 700_000,  16)]   # (lr, step, batch_size)
...
forward_min_attention_alignment = 0        # filter data with bad attention alignment score, if 0 then no filter
