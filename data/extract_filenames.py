...
def extract_descriptions(path):
    target_folders_asr = ['speech-sme-asr/TTS_F-orig_split/wav_txt', ('speech-sme-asr/TTS_F-extra_alle/flac', "speech-sme-asr/TTS_F-extra_alle/txt"), 'speech-sme-asr/TTS_M-orig_split/wav_txt', ('speech-sme-asr/TTS_M-extra_alle/flac', "speech-sme-asr/TTS_M-extra_alle/txt"), ('speech-sme-asr/MANUAL/SEG_NUU', 'speech-sme-asr/MANUAL/WAV22'), 'speech-sme-asr/TTS_M_alle-orig_long_recs_katri_split', 'speech-sme-asr/TTS_F_alle-orig_long_recs_katri_split',]
    target_folders_tts = ['speech-sme-tts/TTS_F-orig_split/wav_txt', ('speech-sme-tts/TTS_F-extra_alle/flac', "speech-sme-tts/TTS_F-extra_alle/txt"), 'speech-sme-tts/TTS_F_alle-orig_long_recs_katri_split']
    descriptions_asr = []
    descriptions_tts = []
    ...
    # print(descriptions[:3])
    return descriptions_asr, descriptions_tts
...
if __name__ == '__main__':
    ...
    descriptions_asr, descriptions_tts = extract_descriptions('./data/speech-sme-asr/')
    print("Writing file...")
